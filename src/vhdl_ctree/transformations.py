...
from .c import nodes as c_nodes
from .c.nodes import Constant, String, SymbolRef, BinaryOp, TernaryOp, \
    Return, While, MultiNode, UnaryOp
from .c.nodes import If, CFile, FunctionCall, FunctionDecl, For, Assign, \
    ArrayRef, Cast
from .nodes import CtreeNode
from .c.nodes import Lt, Gt, AddAssign
from .c.nodes import Break, Continue, Pass, Array, Literal, And
from .c.nodes import Op
from .visitors import NodeTransformer

from .types import get_common_ctype
...
class PyBasicConversions(NodeTransformer):
    ...
    def visit_AugAssign(self, node):
        ...
        if op in lookup:
            return getattr(c_nodes, lookup[op])(target, value)
        return node
