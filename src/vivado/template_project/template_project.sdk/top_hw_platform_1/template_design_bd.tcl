...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net MINIMAL_DMA_CONTROL_0_m_axis [get_bd_intf_pins MINIMAL_DMA_CONTROL_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_net -net MINIMAL_DMA_CONTROL_0_axis_rst [get_bd_ports RST] [get_bd_pins MINIMAL_DMA_CONTROL_0/axis_rst] [get_bd_pins util_vector_logic_0/Op1]
