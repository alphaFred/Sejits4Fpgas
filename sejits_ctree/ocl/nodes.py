...
from sejits_ctree.nodes import *
import hashlib


class OclNode(CtreeNode):
    """Base class for all OpenCL nodes supported by sejits_ctree."""

    def codegen(self, indent=0):
        """generate ocl code for this node"""
        from sejits_ctree.ocl.codegen import OclCodeGen

        return OclCodeGen(indent).visit(self)

    def label(self, indent=0):
        """generate dot element for this node"""
        from sejits_ctree.ocl.dotgen import OclDotLabeller
