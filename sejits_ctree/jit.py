...
import sejits_ctree
from sejits_ctree.nodes import Project
from sejits_ctree.analyses import VerifyOnlyCtreeNodes
from sejits_ctree.frontend import get_ast
from sejits_ctree.transforms import DeclarationFiller
from sejits_ctree.c.nodes import CFile, MultiNode
if sejits_ctree.OCL_ENABLED:
    from sejits_ctree.ocl.nodes import OclFile
...
class LazySpecializedFunction(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        if sejits_ctree.CONFIG.getboolean('jit', 'CACHE') and \
                config_hash in self.concrete_functions:
            sejits_ctree.STATS.log("specialized function cache hit")
            ...
            assert isinstance(csf, ConcreteSpecializedFunction), \
                "Expected a sejits_ctree.jit.ConcreteSpecializedFunction, \
    ...
    def get_tuning_driver(self):
        ...
        """
        from sejits_ctree.tune import ConstantTuningDriver
