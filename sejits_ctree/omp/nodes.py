...
class OmpNode(CtreeNode):
    """Base class for all OpenMP nodes supported by sejits_ctree."""

    def codegen(self, indent=0):
        from sejits_ctree.omp.codegen import OmpCodeGen

        return OmpCodeGen(indent).visit(self)

    def label(self):
        from sejits_ctree.omp.dotgen import OmpDotLabeller
